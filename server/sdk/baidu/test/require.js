...
const filePath  = '/Users/wuqiqing/projects/baidu/aip/sdks/node-sdk/test_sample/assets/antiporn'
...
describe('should all export is valid', function() {
    should.doesNotThrow(function () {
        ...
        //     let tmp = new exp.ocr("", "d18289e60b6a44c281f8985d5106586e", "0f15a705e2ff4400a3757b4acd88114d");
        //     let stat = fs.statSync(filePath+'/docAnalysis.png');
        //     let data = parse(filePath+'/docAnalysis.png');
        ...
        //
        it(' ocr meter ', (done) => {
            let tmp = new exp.contentCensor("", "d18289e60b6a44c281f8985d5106586e", "0f15a705e2ff4400a3757b4acd88114d");
            // let stat = fs.statSync(filePath+'/webimageLoc.png');
            let data = parse(filePath + '/porn2.jpg')
            let p = tmp.textCensorUserDefined('柏柏3333').then((res) => {
                console.log(res);
                done();
            }).catch((err) => {
                console.log(err);
