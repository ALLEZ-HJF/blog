...
const PATH_IMG_USER_DEFINED = '/rest/2.0/solution/v1/img_censor/user_defined';
const PATH_TXT_USER_DEFINED = '/rest/2.0/solution/v1/text_censor/v2/user_defined';
...
class AipImageCensor extends BaseClient {
    ...
    imageCensorUserDefined(image, type) {
        ...
        param.targetPath = PATH_IMG_USER_DEFINED;
        return this.commonImpl(param);
    }
    ...
    textCensorUserDefined(text){
        let param = {};
        param.text = text;
        param.targetPath = PATH_TXT_USER_DEFINED;
        return this.commonImpl(param);
    }
